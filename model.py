...
# Extract team standings data for 2025 season (the table is wrapped inside a comment)
...
# Extract team batting stats for 2025 season
...
# Extract team pitching stats for 2025 season (this table is nested in a comment)
...
for comment in comments2:
    if 'teams_standard_pitching' in comment:
        ...
        if table_pitching:
            df_pitching = pd.read_html(StringIO(str(table)))[0]
